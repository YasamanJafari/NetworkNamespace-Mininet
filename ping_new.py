...
class Ping(object):
	...
	def do(self):
		...
		# if icmp_header == Ping.ECHO_REQUEST:
	...
	def send_one_ping(self, current_socket, msg = "", chunkID = 0):
		...
		randomDst = random.randrange(1, hostsCount)
...
ping(curr_ip, "10.0.0.1")    #put your IP and destination IP address as the ping function argument and run the code. you can ping 
